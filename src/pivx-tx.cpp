...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("mnvip mnvip-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnvip-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnvip transaction") + "\n" +
                               "  mnvip-tx [options] -create [commands]   " + _("Create hex-encoded mnvip transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnvip transaction
