    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of mnvip earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 mnvip");
...
void DashboardWidget::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("mnvip")
    updateDisplayUnit();
}
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair mnvip
...
void DashboardWidget::onChartRefreshed()
{
	...
	set1->setColor(QColor(73,213,159));
