...
public:
    ...
    void setupUi(QDialog *SendCustomFeeDialog)
    {
        ...
        lineEditCustomFee->setPlaceholderText(QStringLiteral("0.0001"));
    ...
    void retranslateUi(QDialog *SendCustomFeeDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("SendCustomFeeDialog", "Customize Fee", Q_NULLPTR));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("SendCustomFeeDialog", "Customize the transaction fee, depending on the fee value your transaction might be included faster in the blockchain", Q_NULLPTR));
        groupBox->setTitle(QString());
        checkBoxRecommended->setText(QApplication::translate("SendCustomFeeDialog", "Recommended", Q_NULLPTR));
        ...
        labelCustomFee->setText(QApplication::translate("SendCustomFeeDialog", "mnvip/kilobyte", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("SendCustomFeeDialog", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("SendCustomFeeDialog", "SAVE", Q_NULLPTR));
    } // retranslateUi
