...
public:
    ...
    void setupUi(QDialog *RequestDialog)
    {
        ...
        lineEditAmount->setPlaceholderText(QStringLiteral("0.00"));
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("RequestDialog", "New Payment Request", Q_NULLPTR));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("RequestDialog", "Instead of sharing only a mnvip address, you can create a payment request, bundling up more information", Q_NULLPTR));
        labelSubtitleAmount->setText(QApplication::translate("RequestDialog", "Amount", Q_NULLPTR));
        comboBoxCoin->setText(QApplication::translate("RequestDialog", "mnvip", Q_NULLPTR));
        labelSubtitleLabel->setText(QApplication::translate("RequestDialog", "Label", Q_NULLPTR));
        lineEditLabel->setPlaceholderText(QApplication::translate("RequestDialog", "Enter a label for the address", Q_NULLPTR));
        labelSubtitleDescription->setText(QApplication::translate("RequestDialog", "Description (optional)", Q_NULLPTR));
        lineEditDescription->setPlaceholderText(QApplication::translate("RequestDialog", "Enter description", Q_NULLPTR));
        ...
        btnSave->setText(QApplication::translate("RequestDialog", "GENERATE", Q_NULLPTR));
    } // retranslateUi
