...
public:
    ...
    void setupUi(QDialog *MasterNodeWizardDialog)
    {
        ...
        lineEditName->setPlaceholderText(QStringLiteral("e.g. user_masternode"));
        ...
        lineEditIpAddress->setPlaceholderText(QStringLiteral("e.g. 18.255.255.255"));
    ...
    void retranslateUi(QDialog *MasterNodeWizardDialog)
    {
        ...
        labelMessage1a->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>To create a mnvip masternode you must dedicate a mnvip amount to the network (however, these coins are still yours and will never leave your possession). </p><p></p><p>You can deactivate the node and unlock the coins at any time.</p></body></html>", Q_NULLPTR));
        labelMessage1b->setText(QApplication::translate("MasterNodeWizardDialog", "Make sure you have this amount of coins.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("MasterNodeWizardDialog", "Set Masternode Name", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>A transaction of the collateral will be made</p><p>to a new empty address in your wallet.</p><p>The Address is labeled under the master node's name.</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("MasterNodeWizardDialog", "Set Masternode IP and Port", Q_NULLPTR));
        ...
        btnBack->setText(QApplication::translate("MasterNodeWizardDialog", "BACK", Q_NULLPTR));
        btnNext->setText(QApplication::translate("MasterNodeWizardDialog", "NEXT", Q_NULLPTR));
    } // retranslateUi
