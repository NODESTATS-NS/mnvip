...
public:
    ...
    void setupUi(QWidget *SendMultiRow)
    {
        ...
        lineEditAmount->setPlaceholderText(QStringLiteral("0.00 mnvip"));
...
"padding:0px;"));
    ...
    void retranslateUi(QWidget *SendMultiRow)
    {
        ...
        labelSubtitleDescription->setText(QApplication::translate("SendMultiRow", "Address label (optional)", Q_NULLPTR));
        lineEditDescription->setPlaceholderText(QApplication::translate("SendMultiRow", "Enter label", Q_NULLPTR));
    } // retranslateUi
