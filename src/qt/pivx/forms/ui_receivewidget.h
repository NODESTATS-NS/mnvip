...
public:
    ...
    void setupUi(QWidget *ReceiveWidget)
    {
        ...
        labelLabel->setText(QStringLiteral("N/A"));
        ...
        labelDate->setText(QStringLiteral("N/A"));
        ...
        labelAddress->setText(QStringLiteral("N/A"));
        ...
        comboBoxSortOrder->setObjectName(QStringLiteral("comboBoxSortOrder"));
    ...
    void retranslateUi(QWidget *ReceiveWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("ReceiveWidget", "Receive", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("ReceiveWidget", "Scan the QR code or copy the address to receive mnvip", Q_NULLPTR));
