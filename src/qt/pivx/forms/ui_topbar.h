...
public:
    ...
    void setupUi(QWidget *TopBar)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("-- mnvip"));
        ...
        labelAmountTopPiv->setText(QStringLiteral("-- mnvip"));
        ...
        labelImmaturePiv->setText(QStringLiteral("- mnvip"));
        ...
        labelPendingPiv->setText(QStringLiteral("-- mnvip"));
        ...
        labelCollateralValue->setText(QStringLiteral("-- mnvip"));
    ...
    void retranslateUi(QWidget *TopBar)
    {
        ...
        labelAvailablePiv->setText(QApplication::translate("TopBar", "-- mnvip", Q_NULLPTR));
        ...
        labelLockedPiv->setText(QApplication::translate("TopBar", "- mnvip", Q_NULLPTR));
        ...
        labelNextCollateralValue->setText(QApplication::translate("TopBar", "-- mnvip", Q_NULLPTR));
