...
"             }"));
        ...
        labelAmountSend->setText(QStringLiteral("0.00 7"));
        ...
        labelTitleTotalRemaining->setText(QStringLiteral("N/A"));
        ...
        labelAmountRemaining->setText(QStringLiteral("N/A"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (mnvip)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "mnvip address or contact label", Q_NULLPTR));
        labelSubtitleAmount->setText(QApplication::translate("send", "Amount", Q_NULLPTR));
        pushButtonFee->setText(QApplication::translate("send", "Customize fee", Q_NULLPTR));
        pushButtonClear->setText(QApplication::translate("send", "Clear all", Q_NULLPTR));
        pushButtonAddRecipient->setText(QApplication::translate("send", "Add recipient", Q_NULLPTR));
        labelTitleTotalSend->setText(QApplication::translate("send", "Total to send", Q_NULLPTR));
        labelLine->setText(QString());
        pushButtonSave->setText(QApplication::translate("send", "Send", Q_NULLPTR));
        pushButtonReset->setText(QApplication::translate("send", "Reset to default", Q_NULLPTR));
    } // retranslateUi
