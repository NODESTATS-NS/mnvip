...
public:
    ...
    PrivateQLabel *labelAmountMNRewards;
    ...
    QLabel *labelSquareMNRewards;
    QLabel *labelMNRewards;
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        lblWarning->setText(QStringLiteral("N/A"));
        ...
        labelSquarePiv->setObjectName(QStringLiteral("labelSquarePiv"));
        ...
        labelPiv->setObjectName(QStringLiteral("labelPiv"));
        labelPiv->setText(QStringLiteral("mnvip"));
...
"margin:0px;"));
        ...
        labelEmptyChart->setText(QStringLiteral("N/A"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelSubtitle->setText(QApplication::translate("DashboardWidget", "View your account's history", Q_NULLPTR));
        imgWarning->setText(QString());
        lblDivisory->setText(QString());
        pushImgEmpty->setText(QString());
        labelEmpty->setText(QApplication::translate("DashboardWidget", "No transactions yet", Q_NULLPTR));
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get mnvip", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Rewards Chart", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of mnvip staked.", Q_NULLPTR));
        labelAmountMNRewards->setText(QApplication::translate("DashboardWidget", "TextLabel", Q_NULLPTR));
        ...
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "mnvip MN", Q_NULLPTR));
        ...
        labelMessageEmpty->setText(QApplication::translate("DashboardWidget", "You can verify the staking activity in the status bar at the top right of the wallet.\n"
"It will start automatically as soon as the wallet has enough confirmations on any unspent balances, and the wallet has synced.", Q_NULLPTR));
    } // retranslateUi
