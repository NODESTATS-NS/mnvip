...
public:
    ...
    void setupUi(QDialog *SendChangeAddressDialog)
    {
        ...
        lineEditAddress->setPlaceholderText(QStringLiteral("e.g. D8FpnBdmahyJNRsVzoKzyFHbGjcUbX43QN"));
    ...
    void retranslateUi(QDialog *SendChangeAddressDialog)
    {
        ...
        labelTitle->setText(QApplication::translate("SendChangeAddressDialog", "Custom Change Address", Q_NULLPTR));
        btnEsc->setText(QString());
        labelMessage->setText(QApplication::translate("SendChangeAddressDialog", "The remainder of the value resultant from the inputs minus the outputs value goes to the \"change\" mnvip address", Q_NULLPTR));
        btnCancel->setText(QApplication::translate("SendChangeAddressDialog", "CANCEL", Q_NULLPTR));
        btnSave->setText(QApplication::translate("SendChangeAddressDialog", "SAVE", Q_NULLPTR));
    } // retranslateUi
