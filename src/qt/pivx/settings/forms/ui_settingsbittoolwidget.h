...
public:
    ...
    void setupUi(QWidget *SettingsBitToolWidget)
    {
        ...
        statusLabel_ENC->setText(QStringLiteral("N/A"));
    ...
    void retranslateUi(QWidget *SettingsBitToolWidget)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsBitToolWidget", "BIP38 Tool", Q_NULLPTR));
        labelSubtitle1->setText(QApplication::translate("SettingsBitToolWidget", "Encrypt your mnvip addresses (key pair actually) using BIP38 encryption.\n"
"Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely", Q_NULLPTR));
        groupBox->setTitle(QString());
        pushLeft->setText(QApplication::translate("SettingsBitToolWidget", "Encrypt", Q_NULLPTR));
        pushRight->setText(QApplication::translate("SettingsBitToolWidget", "Decrypt", Q_NULLPTR));
        labelSubtitleKey->setText(QApplication::translate("SettingsBitToolWidget", "Encrypted key", Q_NULLPTR));
        lineEditKey->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Enter a encrypted key", Q_NULLPTR));
        labelSubtitlePassphrase->setText(QApplication::translate("SettingsBitToolWidget", "Passphrase", Q_NULLPTR));
        lineEditPassphrase->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Enter a passphrase", Q_NULLPTR));
        labelSubtitleDecryptResult->setText(QApplication::translate("SettingsBitToolWidget", "Decrypted address result", Q_NULLPTR));
        lineEditDecryptResult->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Decrypted Address", Q_NULLPTR));
        ...
        pushButtonDecrypt->setText(QApplication::translate("SettingsBitToolWidget", "DECRYPT KEY", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("SettingsBitToolWidget", "mnvip address", Q_NULLPTR));
        addressIn_ENC->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Enter address", Q_NULLPTR));
        labelSubtitleMessage->setText(QApplication::translate("SettingsBitToolWidget", "Passphrase", Q_NULLPTR));
        passphraseIn_ENC->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Enter passphrase", Q_NULLPTR));
        labelSubtitleEncryptedKey->setText(QApplication::translate("SettingsBitToolWidget", "Encrypted Key", Q_NULLPTR));
        encryptedKeyOut_ENC->setPlaceholderText(QApplication::translate("SettingsBitToolWidget", "Encrypted Key", Q_NULLPTR));
        pushButtonClear->setText(QApplication::translate("SettingsBitToolWidget", "CLEAR ALL", Q_NULLPTR));
        pushButtonEncrypt->setText(QApplication::translate("SettingsBitToolWidget", "ENCRYPT", Q_NULLPTR));
    } // retranslateUi
