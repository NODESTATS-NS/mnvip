...
public:
    ...
    void setupUi(QWidget *SettingsSignMessageWidgets)
    {
        ...
        labelSubtitle1->setText(QStringLiteral("N/A"));
...
"}"));
        ...
        statusLabel_SM->setText(QStringLiteral("N/A"));
    ...
    void retranslateUi(QWidget *SettingsSignMessageWidgets)
    {
        ...
        labelTitle->setText(QApplication::translate("SettingsSignMessageWidgets", "Sign/Verify Message", Q_NULLPTR));
        groupBox->setTitle(QString());
        pushSign->setText(QApplication::translate("SettingsSignMessageWidgets", "Sign", Q_NULLPTR));
        pushVerify->setText(QApplication::translate("SettingsSignMessageWidgets", "Verify", Q_NULLPTR));
        labelSubtitleSwitch->setText(QString());
        labelSubtitleAddress->setText(QApplication::translate("SettingsSignMessageWidgets", "mnvip address or contact label", Q_NULLPTR));
        addressIn_SM->setPlaceholderText(QApplication::translate("SettingsSignMessageWidgets", "Enter address", Q_NULLPTR));
        labelSubtitleMessage->setText(QApplication::translate("SettingsSignMessageWidgets", "Message", Q_NULLPTR));
        messageIn_SM->setPlaceholderText(QApplication::translate("SettingsSignMessageWidgets", "Write message here...", Q_NULLPTR));
        labelSubtitleSignature->setText(QApplication::translate("SettingsSignMessageWidgets", "Signature", Q_NULLPTR));
        signatureOut_SM->setPlaceholderText(QApplication::translate("SettingsSignMessageWidgets", "Signature", Q_NULLPTR));
        pushButtonClear->setText(QApplication::translate("SettingsSignMessageWidgets", "CLEAR ALL", Q_NULLPTR));
        pushButtonSave->setText(QApplication::translate("SettingsSignMessageWidgets", "SIGN", Q_NULLPTR));
    } // retranslateUi
