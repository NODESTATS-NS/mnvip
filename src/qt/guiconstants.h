...
/* mnvip GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "mnvip"
#define QAPP_ORG_DOMAIN "mnvip.org"
#define QAPP_APP_NAME_DEFAULT "mnvip-Qt"
#define QAPP_APP_NAME_TESTNET "mnvip-Qt-testnet"
