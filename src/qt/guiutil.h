...
/** Utility functions used by the mnvip Qt UI.
 */
namespace GUIUtil
{
...
// Render mnvip addresses in monospace font
...
// Parse "mnvip:" URI into recipient object, return true on successful parsing
