...
public:
    ...
    QWidget *verticalDisplayWidget;
    QVBoxLayout *verticalDisplayLayout;
    QFrame *line;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        verticalDisplayWidget = new QWidget(tabDisplay);
        verticalDisplayWidget->setObjectName(QStringLiteral("verticalDisplayWidget"));
        verticalDisplayLayout = new QVBoxLayout(verticalDisplayWidget);
        verticalDisplayLayout->setContentsMargins(0, 0, 0, 0);
        verticalDisplayLayout->setObjectName(QStringLiteral("verticalDisplayLayout"));
        line = new QFrame(verticalDisplayWidget);
        line->setObjectName(QStringLiteral("line"));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);

        verticalDisplayLayout->addWidget(line);
        ...
        unitLabel = new QLabel(verticalDisplayWidget);
        ...
        unit = new QValueComboBox(verticalDisplayWidget);
        unit->setObjectName(QStringLiteral("unit"));

        horizontalLayout_3_Display->addWidget(unit);


        verticalDisplayLayout->addLayout(horizontalLayout_3_Display);
        ...
        checkBoxHideZeroBalances = new QCheckBox(verticalDisplayWidget);
        ...
        checkBoxHideOrphans = new QCheckBox(verticalDisplayWidget);
        ...
        verticalDisplayLayout->addLayout(horizontalLayout_5_Display);
        ...
        thirdPartyTxUrlsLabel = new QLabel(verticalDisplayWidget);
        ...
        thirdPartyTxUrls = new QLineEdit(verticalDisplayWidget);
        thirdPartyTxUrls->setObjectName(QStringLiteral("thirdPartyTxUrls"));

        horizontalLayout_6_Display->addWidget(thirdPartyTxUrls);


        verticalDisplayLayout->addLayout(horizontalLayout_6_Display);


        verticalLayout_Display->addWidget(verticalDisplayWidget);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start mnvip after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start mnvip on system login", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the mnvip client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the mnvip network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting mnvip.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://discord.com/invite/2MYYCVPxeU", Q_NULLPTR));
