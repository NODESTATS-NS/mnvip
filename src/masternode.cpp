...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    if (nHeight >   2940000) return        0 * COIN;
    if (nHeight >   2730000) return     0.00488281 * COIN;
    if (nHeight >   2520000) return     0.00976563 * COIN;
    if (nHeight >   2310000) return     0.01953125 * COIN;
    if (nHeight >   2100000) return     0.0390625 * COIN;
    if (nHeight >   1890000) return     0.078125 * COIN;
    if (nHeight >   1680000) return     0.15625 * COIN;
    if (nHeight >   1470000) return     0.3125 * COIN;
    if (nHeight >   1260000) return     0.625 * COIN;
    if (nHeight >   1050000) return     1.25 * COIN;
    if (nHeight >    840000) return      2.5 * COIN;
    if (nHeight >    630000) return        5 * COIN;
    if (nHeight >    420000) return       10 * COIN;
    if (nHeight >    210000) return       20 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 mnvip tx got MASTERNODE_MIN_CONFIRMATIONS
    ...
    if (mi != mapBlockIndex.end() && (*mi).second) {
        ...
        int nConfHeight = pMNIndex->nHeight + MASTERNODE_MIN_CONFIRMATIONS - 1; // block for 1000 mnvip tx -> 1 confirmation
