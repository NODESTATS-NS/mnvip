...
#define PACKAGE_BUGREPORT "https://github.com/mnvip/mnvip"

/* Define to the full name of this package. */
#define PACKAGE_NAME "mnvip Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "mnvip Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mnvip"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://masternode.vip/"
