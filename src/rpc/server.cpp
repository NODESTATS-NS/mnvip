...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* mnvip features */
        {"mnvip", "listmasternodes", &listmasternodes, true },
        {"mnvip", "getmasternodecount", &getmasternodecount, true },
        {"mnvip", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"mnvip", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"mnvip", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"mnvip", "masternodecurrent", &masternodecurrent, true },
        {"mnvip", "startmasternode", &startmasternode, true },
        {"mnvip", "createmasternodekey", &createmasternodekey, true },
        {"mnvip", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"mnvip", "listmasternodeconf", &listmasternodeconf, true },
        {"mnvip", "getmasternodestatus", &getmasternodestatus, true },
        {"mnvip", "getmasternodewinners", &getmasternodewinners, true },
        {"mnvip", "getmasternodescores", &getmasternodescores, true },
        {"mnvip", "mnsync", &mnsync, true },
        {"mnvip", "spork", &spork, true },
...
{
    return "> mnvip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5789/\n";
}
