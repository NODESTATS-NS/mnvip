...
const char * const PIVX_CONF_FILENAME = "mnvip.conf";
const char * const PIVX_PID_FILENAME = "mnvip.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\mnvip
// Windows >= Vista: C:\Users\Username\AppData\Roaming\mnvip
// Mac: ~/Library/Application Support/mnvip
// Unix: ~/.mnvip
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "mnvip";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty mnvip.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=5789\naddnode=seed1.masternode.vip:5788\naddnode=seed2.masternode.vip:5788\naddnode=seed3.masternode.vip:5788\naddnode=seed4.masternode.vip:5788\naddnode=seed5.masternode.vip:5788\naddnode=seed6.masternode.vip:5788\naddnode=seed7.masternode.vip:5788\naddnode=seed8.masternode.vip:5788\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override mnvip.conf
