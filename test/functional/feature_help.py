...
"""Verify that starting mnvip with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mnvip with -? for help text")
        ...
        self.log.info("Start mnvip with -version for version information")
