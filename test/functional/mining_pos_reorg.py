...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected mnvip and zmnvip supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zmnvipsupply']:
                assert_equal(node['zmnvipsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check mnvip and zmnvip supply at the beginning
        # ------------------------------------------
        # zmnvip supply: 2 coins for each denomination
        ...
        # mnvip supply: block rewards minus burned fees for minting
        ...
        # Verify that mnvip and zmnvip supplies were properly updated after the spends and reorgs
        self.log.info("Check mnvip and zmnvip supply...")
