...
#define MyAppName "mnvip Core"
#define MyAppPublisher "2021-2022 The mnvip Developers"
#define MyAppURL "https://github.com/mnvip/mnvip"
#define MyAppExeName "mnvip-qt.exe"
#define MyAppExtraData "https://github.com/mnvip/mnvip/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\mnvip-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\mnvip\mnvip-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\mnvip\mnvip-Qt,strDataDir|{userappdata}\mnvip\}');
  Result := True;
end;
