...
* Fill in the following data:
    * Application Name: `mnvip Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The mnvip Developers`
    * Application Website: `https://masternode.vip/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `mnvip`
* Add application files:
    * Select the file `mnvip-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `mnvip-2.0.0-win64-setup.exe`
