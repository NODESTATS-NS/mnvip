...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='mnvip.conf'
CONFIGFOLDER='/root/.mnvip'
COIN_DAEMON='mnvipd'
COIN_CLI='mnvip-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/mnvip/mnvip/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
