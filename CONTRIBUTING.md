Contributing to mnvip Core
============================

The mnvip Core project operates an open contributor model where anyone is
...
The following applies to code changes to the mnvip Core project, and is not to be
confused with overall mnvip Network Protocol consensus changes.

Whether a pull request is merged into mnvip Core rests with the project merge
...
Patches that change mnvip consensus rules are considerably more involved than
...
Where a patchset proposes to change the mnvip consensus, it must have been
...
The project leader is the release manager for each mnvip Core release.
